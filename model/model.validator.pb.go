...
func (this *CompletionResult) Validate() error {
	if nil == this.Datum {
		return github_com_mwitkow_go_proto_validators.FieldError("Datum", fmt.Errorf("message must exist"))
	}
	if this.Datum != nil {
		if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(this.Datum); err != nil {
			return github_com_mwitkow_go_proto_validators.FieldError("Datum", err)
		}
	}
	return nil
}
func (this *BlobDatum) Validate() error {
	if this.BlobId == "" {
		return github_com_mwitkow_go_proto_validators.FieldError("BlobId", fmt.Errorf(`value '%v' must not be an empty string`, this.BlobId))
	}
	if this.ContentType == "" {
		return github_com_mwitkow_go_proto_validators.FieldError("ContentType", fmt.Errorf(`value '%v' must not be an empty string`, this.ContentType))
	}
	if !(this.Length > 0) {
		return github_com_mwitkow_go_proto_validators.FieldError("Length", fmt.Errorf(`value '%v' must be greater than '0'`, this.Length))
	}
	return nil
}
...
func (this *HTTPRespDatum) Validate() error {
	...
	if !(this.StatusCode > 0) {
		return github_com_mwitkow_go_proto_validators.FieldError("StatusCode", fmt.Errorf(`value '%v' must be greater than '0'`, this.StatusCode))
	}
	return nil
}
...
func (this *StageRefDatum) Validate() error {
	if this.StageId == "" {
		return github_com_mwitkow_go_proto_validators.FieldError("StageId", fmt.Errorf(`value '%v' must not be an empty string`, this.StageId))
	}
	return nil
}
...
func (this *Datum) Validate() error {
	...
	if oneOfNester, ok := this.GetVal().(*Datum_Blob); ok {
		if oneOfNester.Blob != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.Blob); err != nil {
				return github_com_mwitkow_go_proto_validators.FieldError("Blob", err)
			}
		}
	}
	...
	if oneOfNester, ok := this.GetVal().(*Datum_StageRef); ok {
		if oneOfNester.StageRef != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.StageRef); err != nil {
				return github_com_mwitkow_go_proto_validators.FieldError("StageRef", err)
			}
		}
	}
	if oneOfNester, ok := this.GetVal().(*Datum_HttpReq); ok {
		if oneOfNester.HttpReq != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.HttpReq); err != nil {
				return github_com_mwitkow_go_proto_validators.FieldError("HttpReq", err)
			}
		}
	}
	if oneOfNester, ok := this.GetVal().(*Datum_HttpResp); ok {
		if oneOfNester.HttpResp != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.HttpResp); err != nil {
				return github_com_mwitkow_go_proto_validators.FieldError("HttpResp", err)
			}
		}
	}
	if oneOfNester, ok := this.GetVal().(*Datum_Status); ok {
		if oneOfNester.Status != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.Status); err != nil {
...
func (this *AddStageRequest) Validate() error {
	...
	if this.Closure != nil {
		if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(this.Closure); err != nil {
			return github_com_mwitkow_go_proto_validators.FieldError("Closure", err)
		}
	}
	return nil
}
...
func (this *AddDelayStageRequest) Validate() error {
	...
	if !(this.DelayMs > -1) {
		return github_com_mwitkow_go_proto_validators.FieldError("DelayMs", fmt.Errorf(`value '%v' must be greater than '-1'`, this.DelayMs))
	}
	return nil
}

var _regex_AddInvokeFunctionStageRequest_FunctionId = regexp.MustCompile(`^([a-zA-Z0-9_.\-]{1,255})?$`)
...
func (this *AddInvokeFunctionStageRequest) Validate() error {
	...
	if !_regex_AddInvokeFunctionStageRequest_FunctionId.MatchString(this.FunctionId) {
		return github_com_mwitkow_go_proto_validators.FieldError("FunctionId", fmt.Errorf(`function id must be specified`))
	}
	if nil == this.Arg {
		return github_com_mwitkow_go_proto_validators.FieldError("Arg", fmt.Errorf("message must exist"))
	}
	if this.Arg != nil {
		if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(this.Arg); err != nil {
			return github_com_mwitkow_go_proto_validators.FieldError("Arg", err)
		}
	}
	return nil
}
...
var _regex_CreateGraphRequest_FunctionId = regexp.MustCompile(`^([a-zA-Z0-9_.\-]{1,255})?$`)
...
func (this *AwaitStageResultRequest) Validate() error {
	...
	if !(this.TimeoutMs > -1) {
		return github_com_mwitkow_go_proto_validators.FieldError("TimeoutMs", fmt.Errorf(`value '%v' must be greater than '-1'`, this.TimeoutMs))
	}
	return nil
}
...
func (this *InvokeFunctionRequest) Validate() error {
	...
	if !_regex_InvokeFunctionRequest_FunctionId.MatchString(this.FunctionId) {
		return github_com_mwitkow_go_proto_validators.FieldError("FunctionId", fmt.Errorf(`invalid function id`))
	}
	if nil == this.Arg {
		return github_com_mwitkow_go_proto_validators.FieldError("Arg", fmt.Errorf("message must exist"))
	}
...
func (this *InvokeStageRequest) Validate() error {
	...
	if !_regex_InvokeStageRequest_FunctionId.MatchString(this.FunctionId) {
		return github_com_mwitkow_go_proto_validators.FieldError("FunctionId", fmt.Errorf(`value '%v' must be a string conforming to regex "^(\\.|[a-zA-Z0-9_\\-]{1,255})(/[a-zA-Z0-9_/\\-]{0,255})(\\?.*)?$"`, this.FunctionId))
	}
	...
	if nil == this.Closure {
		return github_com_mwitkow_go_proto_validators.FieldError("Closure", fmt.Errorf("message must exist"))
	}
	if this.Closure != nil {
		if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(this.Closure); err != nil {
			return github_com_mwitkow_go_proto_validators.FieldError("Closure", err)
...
func (this *GraphLifecycleEvent) Validate() error {
	if oneOfNester, ok := this.GetVal().(*GraphLifecycleEvent_GraphCreated); ok {
		if oneOfNester.GraphCreated != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.GraphCreated); err != nil {
				return github_com_mwitkow_go_proto_validators.FieldError("GraphCreated", err)
			}
		}
	}
	if oneOfNester, ok := this.GetVal().(*GraphLifecycleEvent_GraphCompleted); ok {
		if oneOfNester.GraphCompleted != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.GraphCompleted); err != nil {
				return github_com_mwitkow_go_proto_validators.FieldError("GraphCompleted", err)
			}
		}
	}
	return nil
...
func (this *GraphStreamEvent) Validate() error {
	if this.SentTs != nil {
		if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(this.SentTs); err != nil {
			return github_com_mwitkow_go_proto_validators.FieldError("SentTs", err)
		}
	}
	...
	if oneOfNester, ok := this.GetVal().(*GraphStreamEvent_GraphTerminating); ok {
		if oneOfNester.GraphTerminating != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.GraphTerminating); err != nil {
				return github_com_mwitkow_go_proto_validators.FieldError("GraphTerminating", err)
			}
		}
	}
	...
	if oneOfNester, ok := this.GetVal().(*GraphStreamEvent_DelayScheduled); ok {
		if oneOfNester.DelayScheduled != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.DelayScheduled); err != nil {
				return github_com_mwitkow_go_proto_validators.FieldError("DelayScheduled", err)
			}
		}
	}
	if oneOfNester, ok := this.GetVal().(*GraphStreamEvent_StageAdded); ok {
		if oneOfNester.StageAdded != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.StageAdded); err != nil {
				return github_com_mwitkow_go_proto_validators.FieldError("StageAdded", err)
			}
		}
	}
	if oneOfNester, ok := this.GetVal().(*GraphStreamEvent_StageCompleted); ok {
		if oneOfNester.StageCompleted != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.StageCompleted); err != nil {
				return github_com_mwitkow_go_proto_validators.FieldError("StageCompleted", err)
			}
		}
	}
	if oneOfNester, ok := this.GetVal().(*GraphStreamEvent_StageComposed); ok {
		if oneOfNester.StageComposed != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.StageComposed); err != nil {
				return github_com_mwitkow_go_proto_validators.FieldError("StageComposed", err)
			}
		}
	}
	if oneOfNester, ok := this.GetVal().(*GraphStreamEvent_FaasInvocationStarted); ok {
		if oneOfNester.FaasInvocationStarted != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.FaasInvocationStarted); err != nil {
				return github_com_mwitkow_go_proto_validators.FieldError("FaasInvocationStarted", err)
			}
		}
	}
	if oneOfNester, ok := this.GetVal().(*GraphStreamEvent_FaasInvocationCompleted); ok {
		if oneOfNester.FaasInvocationCompleted != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.FaasInvocationCompleted); err != nil {
				return github_com_mwitkow_go_proto_validators.FieldError("FaasInvocationCompleted", err)
			}
		}
	}
	if oneOfNester, ok := this.GetVal().(*GraphStreamEvent_GraphCommitted); ok {
		if oneOfNester.GraphCommitted != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.GraphCommitted); err != nil {
				return github_com_mwitkow_go_proto_validators.FieldError("GraphCommitted", err)
			}
		}
	}
	return nil
