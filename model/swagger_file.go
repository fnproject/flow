...
func modelModelSwaggerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "model/model.swagger.json", size: 23688, mode: os.FileMode(420), modTime: time.Unix(1511519871, 0)}
